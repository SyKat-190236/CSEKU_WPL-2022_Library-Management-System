        ...
        <div class="justify-content-center h-100">
          <div class="searchbar">
            <form action="deleteBooks.php" method="post">
                <input class="form-control" type="text" name="search" placeholder="Search with borrow date..."><br>&nbsp;
      ...
      <div class="list-group">
        <table align="center">
                <?php
							...
							{
								$search = $_POST['search'];
								$sql = "SELECT * FROM borrow WHERE issue_date like '%$search%'";
								...
								while($row = mysqli_fetch_assoc($data)){
                                    ...
                                    <td>
                                        <form action="setReturn.php" method="post">
                                            ...
                                            <button class="btn btn-warning" id="workbtn">Set Return Date</button>
                                        </form>
                                    </td>
                                    </tr>
									<?php
                            ...
                            $sql = "SELECT * FROM borrow WHERE approval=1 and payment_status=0 and return_status=0";
                            $data = mysqli_query($conn,$sql);
                            while($row = mysqli_fetch_assoc($data)){
                                $bookid = $row['bookID'];
                                $userid = $row['userID'];
            ...
            <tr class="list-group-item">
              ...
              <td>
                  ...
                  <h6>Borrow date : <?php echo $issuedate; ?></h6>
                  <h6><?php if($returndate!=""){echo "Return Date : "; echo $returndate;}?></h6>
                  <h6>Payment Status : <?php if($payment==0){echo "Unpaid";} else{echo "Paid";} ?></h6>
                  <h6>Borrowed by : <?php echo $user; ?></h6>
              </td>
